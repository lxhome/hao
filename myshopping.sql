...
CREATE TABLE `bank` (
  ...
  `ptr` varchar(5) NOT NULL DEFAULT '1',
  PRIMARY KEY (`account`),
...
INSERT INTO `bank` VALUES ('200930740213','200930740213',9999608,'2013-05-05 05:37:01','1');
...
CREATE TABLE `chat` (
  ...
  `ptr` varchar(3) NOT NULL DEFAULT '1',
  `time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`),
  KEY `FK_1` (`name`),
  CONSTRAINT `FK_1` FOREIGN KEY (`name`) REFERENCES `users` (`name`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `chat` VALUES ('ceshi','1','1','2013-05-05 03:51:56',1),('1','1','1','2013-05-05 03:57:42',2),('1','2','2','2013-05-05 03:58:09',3),('ceshi','2','2','2013-05-05 03:58:22',4),('ceshi','3','2','2013-05-05 03:58:25',5),('ceshi','123','1','2013-05-05 05:32:04',6),('1','123213','2','2013-05-05 05:33:42',7),('ceshi','4','2','2013-05-05 05:33:59',8),('ceshi','2','1','2013-05-05 05:34:08',9);
...
INSERT INTO `flash` VALUES (46,'限量原版短袖T-Shirt',40,1,'root'),(57,'欧美女装蕾丝花边网纱半身中裙',149,16,'root'),(59,'男短袖衬衫',58.01,1,'root');
...
INSERT INTO `shop` VALUES (46,21,3),(46,22,3),(46,24,7),(46,25,1),(46,26,2),(46,28,1),(46,29,1),(46,30,1),(46,32,1),(46,33,1),(46,34,1),(48,28,1),(48,30,1),(48,31,1),(48,33,1),(49,23,1),(49,34,1),(50,27,3),(51,27,1),(51,30,6),(55,30,1);
...
-- Dump completed on 2013-05-05 18:36:19
